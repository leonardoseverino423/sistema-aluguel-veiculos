...
1. Clone o repositório: git clone https://github.com/leonardoseverino423/sistema-aluguel-veiculos.git
2. Acesse a pasta:cd sistema-aluguel-veiculos
3. Execute o programa: python sistema_aluguel.py
